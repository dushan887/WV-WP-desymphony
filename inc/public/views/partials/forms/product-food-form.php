<?php
/**
 * Product‑Food form (modal, right column)
 *
 * @package Wv_Addon
 */
if ( ! defined( 'ABSPATH' ) ) {
...
<div class="wv-food-fields">
	<div class="row gy-8">

		<!-- Product category* -->
		<input type="hidden" id="food-category" name="category" class="wv-input" value="Food" required>

		<!-- Product description* (≤500 chars) -->
		<div class="col-12">
			<div class="wv-input-group position-relative">
				<label class="d-flex justify-content-between" for="food-desc">
