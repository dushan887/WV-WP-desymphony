...
$distributionTags = [
    ...
    'FoodDistributors',
    'SerbianDistributors',
    'N.MacedonianDistributors',
    'AlbanianDistributors',
    'BalkanDistributors',
    'OrganicGoodsDistribution',
    'PremiumGoodsDistribution',
    'BoutiqueBrandsDistribution',
    'DirectTrading',
...
$wholesaleTags = [
    ...
    'FoodWholesalers',
    'SerbianWholesalers',
    'N.MacedonianWholesalers',
    'AlbanianWholesalers',
    'BalkanWholesalers',
    'OrganicGoodsWholesale',
    'PremiumGoodsWholesale',
    'DirectTrading',
    'WholesaleSourcing',
    'SustainableWholesale',
    'VolumePricing',
    'InventorySolutions',
    'WholesaleDelivery',
    'WholesaleLogistics',
    'WholesaleSupplyChain',
];
...
$retailTags = [
    ...
    'FoodRetailers',
    'SerbianRetailers',
    'N.MacedonianRetailers',
    'AlbanianRetailers',
    'BalkanRetailers',
    'OrganicGoodsRetail',
    'PremiumGoodsRetail',
    'BoutiqueBrandsRetail',
    'DirectTrading',
    'RetailSourcing',
    'Shelf-ReadySolutions',
    'SustainableRetail',
    'VolumePricing',
    'RetailDelivery',
    'RetailLogistics',
...
$tagGroups = [
    ...
    'FOOD'         => $foodTags,
    'SPIRITS'       => $rakijaTags,
    'DISTRIBUTION' => $distributionTags,
    'WHOLESALE'    => $wholesaleTags,
    'RETAIL'       => $retailTags,
    'HORECA'       => $horecaTags,
];
