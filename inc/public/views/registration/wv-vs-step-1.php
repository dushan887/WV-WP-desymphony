            ...
            <div class="col-lg-6">
                <label class="wv-custom-radio">
                    <input
                        ...
                        required
                        <?php echo (!empty($saved_data['wv_participationModel']) && $saved_data['wv_participationModel'] === 'Public Visitor') ? 'checked' : ''; ?>
                    >
                    <div class="wv-radio-card pt-48 pb-24">
                        <h3 class="h1">Public Visitor</h3>
                        ...
                        <div class="wv-radio-list-info d-flex fs-12 align-items-center justify-content-between flex-nowrap px-12 py-4 mb-4 br-4">
                            <span>Provide your elementary personal credentials</span>
                        ...
                        <div class="wv-radio-list-info d-flex fs-12 align-items-center justify-content-between flex-nowrap px-12 py-4 br-4">
                            <span class="fw-600">Specify your areas of interest, related to the fair</span>
                            <strong class="ls-5">COMPULSORY</strong>
                        </div>
                    </div>
                </label>
            ...
            <div class="col-lg-6">
                <label class="wv-custom-radio">
                    <input
                        ...
                        value="Company"
                        required
                        <?php echo (!empty($saved_data['wv_participationModel']) && $saved_data['wv_participationModel'] === 'Company') ? 'checked' : ''; ?>
                    >
                    <div class="wv-radio-card pt-48 pb-24">
                        <h3 class="h1">Company</h3>
                        <div class="wv-check my-48">
                            <span class="wv wv_check-50"><span class="path1"></span><span class="path2"></span></span>
                        </div>
                        <div class="wv-radio-list-info d-flex fs-12 align-items-center justify-content-between flex-nowrap px-12 py-4 mb-4 br-4">
                            <span>Participate in B2B Sessions</span>
                            <strong class="ls-5">COMPULSORY</strong>
                        </div>
                        <div class="wv-radio-list-info d-flex fs-12 align-items-center justify-content-between flex-nowrap px-12 py-4 br-4">
                            <span class="fw-600">Apply for Wine Vision Hosted Buyers Program</span>
