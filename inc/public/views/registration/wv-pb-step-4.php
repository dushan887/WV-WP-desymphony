...
$field_value = $saved_data['wv_otherReasonsForVisiting'] ?? '';
?>
        ...
        <div class="row g-12 justify-content-center align-items-stretch">
            <div class="col-12 my-0">
                <label class="wv-label-block d-block my-0 text-center px-32 py-16">
                    <span>Specify your reasons for participating</span>
                </label>
            </div>
            <div class="col-12 my-0">
                <div class="d-block bg-white p-32 br-8 br-t-0 ds-min-h-350">
                    <div class="wv-input-group">
                        <textarea
                            id="wv_otherReasonsForVisiting"
                            name="wv_otherReasonsForVisiting"
                            rows="8"
                            maxlength="200"
                            class="border-0"
