...
$field_value = $saved_data['wv_companyDescription'] ?? '';
?>
...
<div class="wv-step" id="<?php echo esc_attr($step_key); ?>">
    ...
    <div id="wv-step-header" class="px-16 py-16 py-lg-24 text-center">
        <h6 class="my-0 text-uppercase ls-3 fw-600">Company Description</h6>
    </div>

    <!-- Step Body -->
    <div id="wv-step-body" class="py-32 px-24 px-lg-128">
        <div class="d-block text-center mt-0 mb-32">
            <h2 class="text-white mt-0 mb-12 h1">About your company</h2>
            <p class="mb-24 text-uppercase ls-3">IN WRITTEN WORDS, UP TO 700 CHARACTERS</p>
        </div>
