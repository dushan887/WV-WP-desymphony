...
<section class="container-fluid wv-section-box-shadow wv-bg-header-gradient">
  <div class="hall hall_nav d-flex justify-content-center align-items-center py-24">
